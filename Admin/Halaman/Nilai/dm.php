...
<div class="card">
              ...
              <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahnilai">
                  ...
                  $no=1;
                  $tampil = $dm->tampil_dm();
                  while($data_dm = $tampil->fetch_object()){
                  
                  ?>
                  <tr>
                    <td><?= $no++?></td>
                    <td><?=$data_dm->nama_mhs?></td>
                   <td><?=$data_dm->nama_matkul?></td>
                   <td><?=$data_dm->nama_jurusan?></td>
                   <td><?=$data_dm->nama?></td>
                   <td><?=$data_dm->nilai?></td>
                   <td>
                    <a href="" id="ubah_nilai" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalubah" data-id_nilai="<?php echo $data_dm->id_nilai?>" data-id_mhs= "<?php echo $data_dm->id_mhs?>" data-id_matkul="<?php echo $data_dm->id_matkul?>" data-id_dosen="<?php echo $data_dm->id_dosen?>" data-id_jurusan="<?php echo $data_dm->id_jurusan?>" data-nilai="<?php echo $data_dm->nilai?>"><i class="far fa-edit"></i></a> <a href="" id="hapus_nilai" class="btn btn-sm btn-danger"  data-toggle="modal" data-target="#modalhapus" data-id_nilai="<?php echo $data_dm->id_nilai?>"><i class="fas fa-trash"></i></a>
                   </td>
                  </tr>
