              ...
              <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahnilai">
                  ...
                  <tr>
                   ...
                   <td><?= $data_kp->nama_matkul?></td>
                   <td><?= $data_kp->nama_jurusan?></td>
                   <td><?= $data_kp->nama?></td>
                   <td><?= $data_kp->nilai?></td>
                   <td>
                    <a href="" id="ubah_nilai" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalubah" data-id_nilai="<?php echo $data_kp->id_nilai?>" data-id_mhs= "<?php echo $data_kp->id_mhs?>" data-id_matkul="<?php echo $data_kp->id_matkul?>" data-id_dosen="<?php echo $data_kp->id_dosen?>" data-id_jurusan="<?php echo $data_kp->id_jurusan?>" data-nilai="<?php echo $data_kp->nilai?>"><i class="far fa-edit"></i></a> <a href="" id="hapus_nilai" class="btn btn-sm btn-danger"  data-toggle="modal" data-target="#modalhapus" data-id_nilai="<?php echo $data_kp->id_nilai?>"><i class="fas fa-trash"></i></a>
                   </td>
                  </tr>
                   <?php
                  }
