...
$inforkomn = new n_inforkom($koneksi);
...
<div class="card">
              ...
              <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahnilai">
                  ...
                  <?php 
                  $no=1;
                  $tampil = $inforkomn->tampil_inforkomn();
                  while($data_inforkomn = $tampil->fetch_object()){
                  
                  ?>
                  <tr>
                    <td><?= $no++?></td>
                    <td><?= $data_inforkomn->nama_mhs?></td>
                    <td><?= $data_inforkomn->nama_matkul?></td>
                    <td><?= $data_inforkomn->nama?></td>
                    <td><?= $data_inforkomn->nama_jurusan?></td>
                    <td><?= $data_inforkomn->nilai?></td>
                    <td>
                    <a href="" id="ubah_nilai" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalubah" data-id_nilai="<?php echo $data_inforkomn->id_nilai?>" data-id_mhs= "<?php echo $data_inforkomn->id_mhs?>" data-id_matkul="<?php echo $data_inforkomn->id_matkul?>" data-id_dosen="<?php echo $data_inforkomn->id_dosen?>" data-id_jurusan="<?php echo $data_inforkomn->id_jurusan?>" data-nilai="<?php echo $data_inforkomn->nilai?>"><i class="far fa-edit"></i></a> <a href="" id="hapus_nilai" class="btn btn-sm btn-danger"  data-toggle="modal" data-target="#modalhapus" data-id_nilai="<?php echo $data_inforkomn->id_nilai?>"><i class="fas fa-trash"></i></a>
                   </td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      if ($_POST['tambah']) {
        ...
        header('location: ?page=inforkomn');
      }
