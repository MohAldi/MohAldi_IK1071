...
$degrakom = New n_Degrakom($koneksi);
...
<div class="content-wrapper ml-2">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">DEGRAKOM NILAI</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="card">
              ...
              <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahnilai">
                  ...
                  <?php 
                  $no=1;
                  $tampil = $degrakom->tampil_degrakom();
                  while($data_degrakom = $tampil->fetch_object()){
                  
                  ?>
                  <tr>
                    <td><?= $no++?></td>
                    <td><?= $data_degrakom->nama_mhs?></td>
                    <td><?= $data_degrakom->nama_matkul?></td>
                    <td><?= $data_degrakom->nama_jurusan?></td>
                    <td><?= $data_degrakom->nama?></td>
                    <td><?= $data_degrakom->nilai?></td>
                    <td>
                    <a href="" id="ubah_nilai" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalubah" data-id_nilai="<?php echo $data_degrakom->id_nilai?>" data-id_mhs= "<?php echo $data_degrakom->id_mhs?>" data-id_matkul="<?php echo $data_degrakom->id_matkul?>" data-id_dosen="<?php echo $data_degrakom->id_dosen?>" data-id_jurusan="<?php echo $data_degrakom->id_jurusan?>" data-nilai="<?php echo $data_degrakom->nilai?>"><i class="far fa-edit"></i></a> <a href="" id="hapus_nilai" class="btn btn-sm btn-danger"  data-toggle="modal" data-target="#modalhapus" data-id_nilai="<?php echo $data_degrakom->id_nilai?>"><i class="fas fa-trash"></i></a>
                   </td>
                  </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      if ($_POST['tambah']) {
        ...
        header('location: ?page=degrakomn');
      }
