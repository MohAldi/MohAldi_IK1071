...
<div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Inforkom</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#tambahkelas" class="btn btn-primary">
                 +Tambah Data
                  ...
                  <?php 
                  $no=1;
                  $tampil = $inforkom->tampil_inforkom();
                  while($data_inforkom = $tampil->fetch_object()){
                  
                  ?>
                  <tbody>
                  <tr>
                   <td><?= $no++?></td>
                   <td><?= $data_inforkom->kd_kelas?></td>
                   <td><?= $data_inforkom->nama_mhs?></td>
                   <td><?= $data_inforkom->nama_jurusan?></td>
                   <td>
                    <a href="" id="ubah_kelas" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalubah" data-id_kelas="<?php echo $data_inforkom->id_kelas;?>" data-kd_kelas="<?php echo $data_inforkom->kd_kelas;?>" data-id_mhs="<?php echo $data_inforkom->id_mhs;?>" data-id_jurusan="<?php echo $data_inforkom->id_jurusan;?>"><i class="far fa-edit"></i></a> <a href="" id="hapus_kelas" class="btn btn-sm btn-danger"  data-toggle="modal" data-target="#modalhapus" data-id_kelas="<?php echo $data_inforkom->id_kelas;?>"><i class="fas fa-trash"></i></a>
                   </td>
