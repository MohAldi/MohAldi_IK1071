              ...
              <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahkelas" class="btn btn-primary">
                 +Tambah Data
                  ...
                  <tr>
                  <td><?= $no++?></td>
                   <td><?= $data_degrakom->kd_kelas?></td>
                   <td><?= $data_degrakom->nama_mhs?></td>
                   <td><?= $data_degrakom->nama_jurusan?></td>
                   <td>
                    <a href="" id="ubah_kelas" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalubah" data-id_kelas="<?php echo $data_degrakom->id_kelas;?>" data-kd_kelas="<?php echo $data_degrakom->kd_kelas;?>" data-id_mhs="<?php echo $data_degrakom->id_mhs;?>" data-id_jurusan="<?php echo $data_degrakom->id_jurusan;?>"><i class="far fa-edit"></i></a> <a href="" id="hapus_kelas" class="btn btn-sm btn-danger"  data-toggle="modal" data-target="#modalhapus" data-id_kelas="<?php echo $data_degrakom->id_kelas;?>"><i class="fas fa-trash"></i></a>
                   </td>
                  </tr>
